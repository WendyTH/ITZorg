...
public class FourthActivity  extends AppCompatActivity implements YouTubePlayer.OnInitializedListener{
    ...
    public void addListenerOnButton(){
        imageButton = (ImageButton) findViewById(R.id.next_btn4);

        imageButton.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View arg0) {
                Intent myIntent = new Intent(FourthActivity.this,
                        FifthActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent i = new Intent(FourthActivity.this, Settings.class);
            startActivity(i);
        }
