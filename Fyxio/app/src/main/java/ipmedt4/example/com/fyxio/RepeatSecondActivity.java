...
public class RepeatSecondActivity extends AppCompatActivity implements YouTubePlayer.OnInitializedListener{
    ...
    public void addListenerOnButton(){
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                Intent myIntent = new Intent(RepeatSecondActivity.this,
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent i = new Intent(RepeatSecondActivity.this, Settings.class);
            startActivity(i);
        }
