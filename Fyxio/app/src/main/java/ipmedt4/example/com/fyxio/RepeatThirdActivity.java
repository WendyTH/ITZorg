...
public class RepeatThirdActivity extends AppCompatActivity implements YouTubePlayer.OnInitializedListener{
    ...
    public void addListenerOnButton(){
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                Intent myIntent = new Intent(RepeatThirdActivity.this,
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent i = new Intent(RepeatThirdActivity.this, Settings.class);
            startActivity(i);
        }
