...
public class RepeatFourthActivity extends AppCompatActivity implements YouTubePlayer.OnInitializedListener{
    ...
    public void addListenerOnButton(){
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                Intent myIntent = new Intent(RepeatFourthActivity.this,
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent i = new Intent(RepeatFourthActivity.this, Settings.class);
            startActivity(i);
        }
